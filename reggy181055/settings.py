"""
Django settings for reggy181055 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-r+(68l&m6oo39=z#avg5byqm#6&x*t1i1^9y3y4l&4=3(54-@d')
...
WSGI_APPLICATION = 'reggy181055.wsgi.application'
